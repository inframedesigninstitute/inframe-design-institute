export default function TrustedPlatform() {
    ...
    return (
        <div className="w-full px-6 p-3">
            <div className="max-w-[1320px] mx-auto lg:py-[30px] py-[30px]">
                ...
                <div className="grid lg:grid-cols-4 sm:grid-cols-2 grid-cols-1 items-center lg:gap-10 gap-5 my-[30px] ">
                    {data.map((item, index) => {
                        return (
                            ...
                            >
                                <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/50 to-transparent rounded-[10px] lg:rounded-[25px] z-10"></div>

                                <div className="z-40 ">
                                    <h3 className="text-center text-white font-semibold lg:text-[40px] text-[30px] mb-2">{item.heading}</h3>
